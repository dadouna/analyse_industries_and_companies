...
class _html2text(HTMLParser.HTMLParser):
    ...
    def o(self, data, puredata=0, horse=0):
        ...
        if not self.quiet:
            ...
            if puredata and not self.pre:
                ...
                if data and data[0] == ' ':
                    self.space = 1
                    data = data[1:]
            if not data and not horse: return
            ...
            bq = (">" * self.blockquote)
            if not (horse and data and data[0] == ">") and self.blockquote: bq += " "
            ...
            if self.a and ((self.p_p == 2 and LINKS_EACH_PARAGRAPH) or horse == "end"):
                if horse == "end": self.out("\n")
            ...
            if self.abbr_list and horse == "end":
